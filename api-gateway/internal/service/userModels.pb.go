...
type UserModel struct {
	...
	// 用户名
	// @inject_tag: json:"user_name" validate:"required,min=2,max=32"
	UserName string `protobuf:"bytes,2,opt,name=UserName,proto3" json:"UserName,omitempty"`
	// 昵称
	// @inject_tag: json:"nick_name" validate:"required,min=2,max=32"
...
var file_userModels_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x04, 0x52, 0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x12, 0x1a, 0x0a, 0x08, 0x55,
